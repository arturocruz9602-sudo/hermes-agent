...
class TestBuildJobPromptBumpUse:
    ...
    def test_bump_use_called_for_loaded_skill(self):
        ...
        # skill_dir is always None here: the mocked skill_view() response
        # carries no "skill_dir" key (see tools.skill_usage path-keying).
        assert all(
            call.kwargs == {"skill_dir": None, "task_id": "cron-task"}
