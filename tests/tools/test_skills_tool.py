...
class TestSkillView:
    ...
    def test_registered_view_tracks_use_with_task_and_session(self, tmp_path):
        ...
        # skill_dir is passed too (path-keyed usage records, see
        # tools.skill_usage) -- ANY since the exact tmp_path varies per run.
        bump_view.assert_called_once_with("my-skill", skill_dir=ANY)
